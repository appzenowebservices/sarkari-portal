        ...
        <AdminTable
          ...
          header={
            <tr>
              ...
              <SortTh label="श्रेणी" col="titleHi" sortCol={sortCol} sortDir={sortDir} onClick={() => handleSort("titleHi")} />
              <SortTh label="Slug" col="slug" sortCol={sortCol} sortDir={sortDir} onClick={() => handleSort("slug")} />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="नाम (English)" required>
              <input
                ...
                placeholder="e.g. Military Recruitment"
              />
            </Field>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Slug" hint="URL के लिए — a-z, 0-9, '-'">
              <input
                ...
                placeholder="खाली छोड़ें — अपने-आप बनेगा"
              />
            </Field>
          </div>
